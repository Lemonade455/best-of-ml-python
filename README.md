...
- [GitHub](https://github.com/google/flax) (👨‍💻 280 · 🔀 730 · 📥 61 · 📦 15K · 📋 1.1K - 20% open · ⏱️ 27.10.2025):
...
- [GitHub](https://github.com/numenta/nupic-legacy) (👨‍💻 120 · 🔀 1.5K · 📥 26 · 📦 21 · 📋 1.8K - 25% open · ⏱️ 03.12.2024):
	...
	```
- [PyPi](https://pypi.org/project/nupic) (📥 510 / month):
	```
	pip install nupic
	```
</details>
...
- [GitHub](https://github.com/nubank/fklearn) (👨‍💻 55 · 🔀 170 · 📦 16 · 📋 51 - 50% open · ⏱️ 23.04.2025):
	...
	```
- [PyPi](https://pypi.org/project/fklearn) (📥 750 / month):
	```
	pip install fklearn
	```
</details>
...
- [GitHub](https://github.com/voxel51/fiftyone) (👨‍💻 160 · 🔀 670 · 📦 1K · 📋 1.7K - 32% open · ⏱️ 29.10.2025):
...
- [GitHub](https://github.com/pyvista/pyvista) (👨‍💻 190 · 🔀 590 · 📥 960 · 📦 5.2K · 📋 1.9K - 31% open · ⏱️ 28.10.2025):
...
- [GitHub](https://github.com/holoviz/holoviews) (👨‍💻 150 · 🔀 400 · 📦 17K · 📋 3.4K - 31% open · ⏱️ 29.10.2025):
...
- [GitHub](https://github.com/xflr6/graphviz) (👨‍💻 24 · 🔀 220 · 📦 95K · 📋 190 - 4% open · ⏱️ 26.10.2025):
...
- [GitHub](https://github.com/SciTools/cartopy) (👨‍💻 140 · 🔀 380 · 📦 8.1K · 📋 1.3K - 22% open · ⏱️ 30.10.2025):
...
- [GitHub](https://github.com/NVIDIA-NeMo/NeMo) (👨‍💻 460 · 🔀 3.1K · 📥 520K · 📦 21 · 📋 2.8K - 4% open · ⏱️ 29.10.2025):
...
- [GitHub](https://github.com/deepset-ai/haystack) (👨‍💻 310 · 🔀 2.4K · 📦 1.3K · 📋 4.1K - 2% open · ⏱️ 30.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/haystack) (📥 7.4K / month):
	```
...
- [GitHub](https://github.com/sloria/TextBlob) (👨‍💻 37 · 🔀 1.2K · 📥 140 · 📦 60K · 📋 280 - 24% open · ⏱️ 18.10.2025):
...
- [GitHub](https://github.com/snowballstem/snowball) (👨‍💻 41 · 🔀 180 · 📦 11 · 📋 110 - 14% open · ⏱️ 28.10.2025):
...
- [GitHub](https://github.com/unum-cloud/UForm) (👨‍💻 21 · 🔀 76 · 📥 710 · 📦 36 · 📋 39 - 38% open · ⏱️ 03.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/uform) (📥 490 / month):
	```
	pip install uform
	```
</details>
...
- [GitHub](https://github.com/ipazc/mtcnn) (👨‍💻 15 · 🔀 520 · 📥 76 · 📦 9.2K · 📋 110 - 25% open · ⏱️ 08.10.2024):
...
- [GitHub](https://github.com/espnet/espnet) (👨‍💻 520 · 🔀 2.2K · 📥 84 · 📦 480 · 📋 2.5K - 0% open · ⏱️ 28.10.2025):
...
- [GitHub](https://github.com/beetbox/audioread) (👨‍💻 26 · 🔀 110 · 📦 35K · 📋 92 - 36% open · ⏱️ 26.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/audioread) (📥 4.8M / month):
	```
...
- [GitHub](https://github.com/alkaline-ml/pmdarima) (👨‍💻 23 · 🔀 250 · 📦 13K · 📋 340 - 19% open · ⏱️ 07.11.2024):
	...
	```
- [PyPi](https://pypi.org/project/pmdarima) (📥 7.5M / month):
	```
...
- [GitHub](https://github.com/hail-is/hail) (👨‍💻 100 · 🔀 250 · 📦 170 · 📋 2.5K - 9% open · ⏱️ 29.10.2025):
...
- [GitHub](https://github.com/skrub-data/skrub) (👨‍💻 82 · 🔀 170 · 📦 100 · 📋 550 - 18% open · ⏱️ 30.10.2025):

	```
	git clone https://github.com/skrub-data/skrub
	```
- [PyPi](https://pypi.org/project/skrub) (📥 45K / month):
	```
	pip install skrub
	```
</details>
...
- [GitHub](https://github.com/autogluon/autogluon) (👨‍💻 140 · 🔀 1.1K · 📦 1.2K · 📋 1.7K - 22% open · ⏱️ 29.10.2025):
...
- [GitHub](https://github.com/AutoViML/featurewiz) (👨‍💻 18 · 🔀 98 · 📋 110 - 0% open · ⏱️ 19.02.2025):
	...
	```
- [PyPi](https://pypi.org/project/featurewiz) (📥 4.6K / month):
	```
...
- [GitHub](https://github.com/facebookresearch/ReAgent) (👨‍💻 170 · 🔀 520 · 📋 110 - 30% open · ⏱️ 17.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/reagent) (📥 50 / month):
	```
	pip install reagent
	```
</details>
...
- [GitHub](https://github.com/meta-pytorch/torchrec) (👨‍💻 400 · 🔀 560 · 📦 240 · 📋 240 - 32% open · ⏱️ 30.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/torchrec-nightly-cpu) (📥 160 / month):
	```
...
- [GitHub](https://github.com/lenskit/lkpy) (👨‍💻 25 · 🔀 71 · 📦 140 · 📋 280 - 32% open · ⏱️ 29.10.2025):

	```
	git clone https://github.com/lenskit/lkpy
	```
- [PyPi](https://pypi.org/project/lenskit) (📥 6.6K / month):
	```
	pip install lenskit
	```
...
- [GitHub](https://github.com/snakemake/snakemake) (👨‍💻 380 · 🔀 590 · 📦 2.5K · 📋 2K - 56% open · ⏱️ 29.10.2025):
...
- [GitHub](https://github.com/mrpowers-io/quinn) (👨‍💻 31 · 🔀 98 · 📥 69 · 📦 94 · 📋 120 - 18% open · ⏱️ 06.12.2024):
	...
	```
- [PyPi](https://pypi.org/project/quinn) (📥 750K / month):
	```
	pip install quinn
	```
</details>
...
- [GitHub](https://github.com/microsoft/tensorwatch) (👨‍💻 15 · 🔀 360 · 📦 160 · 📋 70 - 75% open · ⏱️ 27.09.2025):
	...
	```
- [PyPi](https://pypi.org/project/tensorwatch) (📥 1.4K / month):
	```
...
- [GitHub](https://github.com/triton-lang/triton) (👨‍💻 480 · 🔀 2.1K · 📥 1.4K · 📦 74K · 📋 2K - 41% open · ⏱️ 29.10.2025):

	```
	git clone https://github.com/openai/triton
	```
- [PyPi](https://pypi.org/project/triton) (📥 41M / month):
	```
	pip install triton
	```
</details>
...
- [GitHub](https://github.com/huggingface/huggingface_hub) (👨‍💻 280 · 🔀 830 · 📋 1.3K - 10% open · ⏱️ 29.10.2025):
...
- [GitHub](https://github.com/unum-cloud/USearch) (👨‍💻 81 · 🔀 220 · 📥 110K · 📦 210 · 📋 240 - 30% open · ⏱️ 29.10.2025):
...
- [GitHub](https://github.com/KomputeProject/kompute) (👨‍💻 35 · 🔀 160 · 📥 700 · 📋 230 - 32% open · ⏱️ 05.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/kp) (📥 1.8K / month):
	```
	pip install kp
	```
</details>
...
- [GitHub](https://github.com/scipy/scipy) (👨‍💻 1.8K · 🔀 5.4K · 📥 97K · 📦 1.4M · 📋 11K - 13% open · ⏱️ 30.10.2025):

	```
	git clone https://github.com/scipy/scipy
	```
- [PyPi](https://pypi.org/project/scipy) (📥 220M / month):
	```
	pip install scipy
	```
...
- [GitHub](https://github.com/gradio-app/gradio) (👨‍💻 450 · 🔀 3.1K · 📦 84K · 📋 6.1K - 6% open · ⏱️ 29.10.2025):
...
- [GitHub](https://github.com/HIPS/autograd) (👨‍💻 64 · 🔀 890 · 📦 14K · 📋 420 - 38% open · ⏱️ 27.10.2025):
...
- [GitHub](https://github.com/simonw/datasette) (👨‍💻 82 · 🔀 770 · 📥 75 · 📦 1.6K · 📋 1.9K - 31% open · ⏱️ 26.10.2025):
...
- [GitHub](https://github.com/adapter-hub/adapters) (👨‍💻 17 · 🔀 360 · 📦 260 · 📋 410 - 10% open · ⏱️ 12.10.2025):
	...
	```
- [PyPi](https://pypi.org/project/adapter-transformers) (📥 4.9K / month):
	```
